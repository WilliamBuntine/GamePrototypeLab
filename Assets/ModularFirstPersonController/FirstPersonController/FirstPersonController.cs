...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Mouse0)) // Left Mouse (M1)
        {
            // Ray from camera center (cursor in the middle of the screen)
            ...
            {
                Debug.Log("No hit within " + maxDistance);
            }
        }
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        #region Grapple Mechanics
        EditorGUILayout.Space();
        GUILayout.Label("Grapple");
        EditorGUILayout.Space();

        fpc.maxDistance = EditorGUILayout.Slider(new GUIContent("Range", "Determines range the grapple can reach."), fpc.maxDistance, 1, 100);
        fpc.reelSpeed = EditorGUILayout.Slider(new GUIContent("Grapple Speed", "How fast the grapple reels you in."), fpc.reelSpeed, 1, 100);
